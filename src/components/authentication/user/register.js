			...
			<div className="register-container">
				...
				<div class="row">
							...
							<div className="form-group">
								...
								<div className="row">
									...
									<div className="col col-lg-4 col-md-4 col-sm-4">
										<div className={this.state.isVerified ? 'text-success' : 'text-danger'}>
							...
							<div className="form-group">
								...
								<div class="row">
									<div class="col col-sm-8">
										...
										<div
											className={
												this.state.errors['phone'] == null ? 'text-success' : 'text-danger'
											}
										>
					...
					<div class="col col-lg-5 col-md-5 col-sm-5 col-xs-5 fixed fixed-col">
						<img src={books} height="400vh" width="auto" />
					</div>
				</div>
			</div>
		);
